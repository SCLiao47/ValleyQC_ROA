...
% h_ROA_ori_CS = plot_ellipse(2.6883, cxy, Inx, [0 0.4470 0.7410]);
% set(h_ROA_ori_CS,'linewidth',3,'linestyle','--');


% h_ROA_ori_CSValley = plot_ellipse(3.1110, cxy, Inx, [0.4660 0.6740 0.1880]);
% set(h_ROA_ori_CSValley,'linewidth',3);
...
% h_max = plot_ellipse(5, cxy, Inx, [1,1,1]*0);
% set(h_max, 'linewidth',3);
...
% set(gcf,'position',[1009 470 654 288]);

% hl = legend(hs, {'Case 1 [6]','Case 2','Case 3','Case 4'});
% hl = legend(h_ROA_ori_CS, 'Case 1 [3]');
% hl = legend([h_ROA_ori_CS; h_ROA_mon_CS], {'Case 1 [3]','Case 2'});
% hl = legend([h_ROA_ori_CS; h_ROA_mon_CS; h_ROA_ori_CSValley], {'Case 1 [3]','Case 2','Case 3'});
% hl = legend(hs, {'Case 1 [3]','Case 2','Case 3','Case 4'});
% hl = legend([hs; h_max], {'Case 1 [3]','Case 2','Case 3','Case 4','Optimum'})
...
% print('figure/MCC_2state', '-dpng', '-r600')
print('figure/MCC/Cases', '-dpng', '-r600')
